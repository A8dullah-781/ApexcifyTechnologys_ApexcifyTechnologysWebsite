...
>
  ...
  <MdOutlineDoneOutline />
            ...
            <div className="title font-semibold text-[4vw] md:text-[2vw]">Professional Agency</div>
            
            <div className="kya font-medium text-[3vw] md:text-[1.2vw]">Your trusted partner for innovative, <br /> high impact digital solutions.</div>
        </div>
        </div>
  ...
  <MdOutlineDoneOutline />
                 ...
                 <div className='flex flex-col justify-center items-start gap-2' >
            <div className="title font-semibold text-[4vw] md:text-[2vw]">Solutions Provider</div>
