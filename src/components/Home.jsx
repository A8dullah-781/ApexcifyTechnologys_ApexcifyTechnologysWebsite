...
const Home = () => {
  ...
  return (
      ...
      <div className='w-full h-[60vh] lg:h-screen   bg-cover bg-center bg-no-repeat'
        ...
        <div className='  flex lg:mt-15 mt-10 flex-col w-[90vw] lg:w-[80vw]'>
            <div className=' gap-4  justify-center items-center flex flex-col h-full '>
                <div className=' flex justify-center text-center items-center flex-col'>
                    <div className='font-semibold md:leading-none text-[5vw] lg:text-[4.5vw] uppercase'>We create digital experiences </div>
                    <div className='font-semibold  leading-none  text-[6vw] lg:text-[5vw] uppercase'> that inspire growth.</div>
                     <div className='font-normal w-[90%] text-center pt-4 lg:pt-7 text-[3vw] lg:text-[1.5vw]'>Empowering businesses with creative, reliable, and innovative digital solutions that drive growth and lasting impact.</div>
            <button
      className="
        px-8 py-3 
        lg:text-[1.3vw]
  ...
  {[...Array(16)].map((_, i) => (
    <img
      key={i}
      src={`/images/${i % 4 === 0 ? 'dribble' : i % 4 === 1 ? 'envato' : i % 4 === 2 ? 'insta' : 'jquery'}.png`}
      alt=""
      className="
