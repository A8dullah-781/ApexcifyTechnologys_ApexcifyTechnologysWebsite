...
>
  ...
  style={{ backgroundImage: "url('/images/bg.PNG')"}}>
    <div className='flex justify-center gap-0 items-center flex-col' >
      <div className='lg:text-[5vw] text-[9vw]  font-bold text-white' ><Counter target={500}/>+</div>
      <div className='lg:text-[1.5vw] text-[3vw] font-semibold  text-white'>Projects Delivered
with <br /> Expertise and Excellence.
</div>
    </div>
    <div className='flex justify-center gap-0 items-center flex-col' >
      <div className='lg:text-[5vw] text-[9vw]   font-bold text-white' ><Counter target={30}/>+</div>
      <div className='lg:text-[1.5vw] text-[3vw]  font-semibold  text-white'>Awards Recognizing
Our <br /> Commitment to Excellence.
</div>
    </div>
  </div>
     </div>
        <div className="lg:w-1/2 h-full lg:-ml-22 justify-center items-center lg:items-start flex gap-6 flex-col  lg:pl-30 ">
         ...
         <div className="flex gap-5 lg:gap-0">
           <div className="flex flex-col px-5 lg:px-0 items-center justify-center">
            <Circle target={58} />
            <div className="text-[3vw] lg:text-[1.5vw]  font-semibold ">Company Growth</div>
          </div>
           <div className="flex flex-col px-5 lg:px-0items-center justify-center">
                <Circle target={92} />
                <div className="text-[3vw] lg:text-[1.5vw] font-semibold">Satisfied Clients</div>
          </div>
         </div>
