...
const Footer = () => {
 ...
 <div className="flex justify-center 
  ...
  {['Home', 'About', 'Services'].map((link) => (
    ...
    >
      {link}
      {/* underline text ke bilkul neeche */}
      <span className="absolute left-0 bottom-15 w-0 
        cursor-none h-[2px] bg-white transition-all duration-300 group-hover:w-full"></span>
    </a>
  ))}
</div>
